...
elseif(environment == 4)  % ============== Sedation / MRC-CBU (Srivas) ============== %
    ...
    %matrixFolder
    folderMatrix = '/imaging/sc03/Sedation-RestingState/matrix/';
    % measures folder
    folderMeasures = '/imaging/sc03/Iulia/Sedation/measures/';
    % figures folder
    folderFigures = '/imaging/sc03/Iulia/Sedation/figures/';
    %std dev folder
    folderStdDev = '/imaging/sc03/Sedation-RestingState/stddev/';
    % pow contributions folder
...
{'p99_overnight1 20120703 1645'}, 1, 6915828, 500,      250, 0.1, 0.1, 0.1;
];
